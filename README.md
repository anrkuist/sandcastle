...
| `--agent`                 | No       | Interactive prompt           | Agent to use (`antigravity`, `claude-code`, `pi`, `codex`, `cursor`, `opencode`, `copilot`)                    |
...
| Option                     | Type               | Default                       | Description                                                                                                                                                                                                                                           |
| -------------------------- | ------------------ | ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `agent`                    | AgentProvider      | —                             | **Required.** Agent provider (e.g. `antigravity("gemini-3.5-flash")`, `claudeCode("claude-opus-4-7")`, `pi("claude-sonnet-4-6")`, `codex("gpt-5.4-mini")`, `cursor("composer-2")`, `opencode("opencode/big-pickle")`, `copilot("claude-sonnet-4.5")`) |
